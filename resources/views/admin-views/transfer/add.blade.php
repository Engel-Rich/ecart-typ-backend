...
@section('title', \App\Utils\translate('add_new_transfer'))
        ...
        <div class="row align-items-center mb-3">
            <div class="col-sm mb-2 mb-sm-0">
                <h1 class="page-header-title d-flex align-items-center g-2px text-capitalize"><i class="tio-add-circle-outlined"></i>
                    {{ \App\Utils\translate('add_new_transfer') }}
                </h1>
            </div>
        </div>
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                            for="exampleFormControlInput1">{{ \App\Utils\translate('account_from') }}</label>
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="description" class="form-control"
                                            placeholder="{{ \App\Utils\translate('description') }}" required>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
        ...
        <div class="row align-items-center mb-2">
            <div class="col-sm mb-2 mb-sm-0">
                <h1 class="page-header-title d-flex align-items-center g-2px text-capitalize"><i class="tio-files"></i>
                    {{ \App\Utils\translate('transfer_list') }}
                            ...
                            <tbody>
                                @foreach ($transfers as $key => $transfer)
                                    <tr>
                                        ...
                                        <td>
                                            {{ priceCurrencyFormatPlacing($transfer->amount, \App\Utils\Helpers::currency_symbol(), \App\Utils\Helpers::currency_position()) }}
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            {{ priceCurrencyFormatPlacing($transfer->balance, \App\Utils\Helpers::currency_symbol(), \App\Utils\Helpers::currency_position()) }}
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
