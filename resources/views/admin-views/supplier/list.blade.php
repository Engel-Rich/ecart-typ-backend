...
@section('title',\App\Utils\translate('supplier_list'))
        ...
        <div class="row align-items-center mb-3">
            <div class="col-sm mb-2 mb-sm-0">
                <h1 class="page-header-title d-flex align-items-center g-2px text-capitalize"><i
                        class="tio-filter-list"></i> {{\App\Utils\translate('supplier_list')}}
                        ...
                        <div class="row justify-content-between align-items-center flex-grow-1">
                                ...
                                <form action="{{url()->current()}}" method="GET">
                                    <div class="input-group input-group-merge input-group-flush">
                                        ...
                                        <input id="datatableSearch_" type="search" name="search" class="form-control"
                                               placeholder="{{\App\Utils\translate('search_by_name_or_phone')}}" aria-label="{{\App\Utils\translate('Search')}}" value="{{ $search }}" required>
                            ...
                            <div class="col-12 col-md-6">
                                <a href="{{route('admin.supplier.add')}}" class="btn btn-primary float-right"><i
                                        class="tio-add-circle"></i> {{\App\Utils\translate('add_new_supplier')}}
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive datatable-custom">
                        <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                            ...
                            <tr>
                                ...
                                <th class="hide-div-sl">{{\App\Utils\translate('email')}}</th>
                                <th class="hide-div-sl"> {{ \App\Utils\translate('phone') }}</th>
                                <th>{{ \App\Utils\translate('products') }}</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a data-toggle="tooltip" class="badge badge-soft-info" href="{{ route('admin.supplier.products',[$supplier['id']]) }}"
                                            title="{{ \App\Utils\translate('product_view') }}">
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-white mr-1 form-alert" href="javascript:"
                                           ...
                                           data-message="{{ \App\Utils\translate('Want to delete this supplier') }}?"><span class="tio-delete"></span></a>
