...
@section('title', \App\Utils\translate('shop_setup'))
@push('css_or_js')
    <link rel="stylesheet" href="{{ asset('assets/admin') }}/css/custom.css" />
    <link rel="stylesheet" href="{{ asset('assets/admin') }}/css/label.css" />
@endpush
    ...
    <div class="content container-fluid">
        <div class="row align-items-center mb-3">
            <div class="col-sm mb-2 mb-sm-0">
                <h1 class="page-header-title d-flex align-items-center g-2px text-capitalize">{{ \App\Utils\translate('shop_setup') }}</h1>
            </div>
        </div>
        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlInput1">{{ \App\Utils\translate('shop_name') }} </label>
                                        <input type="text" name="shop_name" value="{{ $shopName }}"
                                            class="form-control" placeholder="{{ \App\Utils\translate('shop_name') }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    @php($shopEmail = \App\Models\BusinessSetting::where('key', 'shop_email')->first()->value)
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlInput1">{{ \App\Utils\translate('shop_email') }} </label>
                                        <input type="email" name="shop_email" value="{{ $shopEmail }}"
                                            class="form-control" placeholder="{{ \App\Utils\translate('shop_email') }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    @php($shopPhone = \App\Models\BusinessSetting::where('key', 'shop_phone')->first()->value)
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlInput1">{{ \App\Utils\translate('shop_phone') }} </label>
                                        <input type="text" name="shop_phone" value="{{ $shopPhone }}"
                                               class="form-control" placeholder="{{ \App\Utils\translate('shop_phone') }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    @php($shopAddress = \App\Models\BusinessSetting::where('key', 'shop_address')->first()->value)
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlInput1">{{ \App\Utils\translate('shop_address') }}</label>
                                        <input type="text" name="shop_address" value="{{ $shopAddress }}"
                                               class="form-control" placeholder="{{ \App\Utils\translate('shop_address') }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    @php($paginationLimit = \App\Models\BusinessSetting::where('key', 'pagination_limit')->first()->value)
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlInput1">{{ \App\Utils\translate('pagination_limit') }}</label>
                                        <input min="1" type="number" name="pagination_limit" value="{{ $paginationLimit }}"
                                               class="form-control" placeholder="{{ \App\Utils\translate('pagination_limit') }}" id="pagination_limit" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-2 mb-3 mb-lg-2">
                                    @php($currencyCode = \App\Models\BusinessSetting::where('key', 'currency')->first()->value)
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlInput1">{{ \App\Utils\translate('currency') }}</label>
                                ...
                                <div class="col-sm-6 col-lg-2 mb-3 mb-lg-2">
                                    ...
                                    <label class="input-label">{{ \App\Utils\translate('currency_position') }}</label>
                                    <div class="form-group mt-4 form-inline">
                                        <label class="ml-2">
                                            <input type="radio" name="currency_position" value="left"
                                            {{ $currencyPosition == 'left' ? 'checked' : '' }}/>
                                            <span>{{ \App\Utils\translate('€100 (Left)') }}</span>
                                        </label>
                                        <label class="ml-2">
                                            <input type="radio" name="currency_position" value="right"
                                            {{ $currencyPosition == 'right' ? 'checked' : '' }}/>
                                            <span>{{ \App\Utils\translate('100€ (Right)') }}</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    <div class="form-group">
                                        <label class="input-label" for="country">{{ \App\Utils\translate('country') }}</label>
                                ...
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlInput1">{{ \App\Utils\translate('footer_text') }}</label>
                                        <input type="text" name="footer_text" value="{{ $footerText }}"
                                               class="form-control" placeholder="{{ \App\Utils\translate('footer_text') }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    @php($stockLimit = \App\Models\BusinessSetting::where('key', 'stock_limit')->first()->value)
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlInput1">{{ \App\Utils\translate('minimum_stock_limit_for_warning') }}</label>
                                        <input type="number" name="stock_limit" value="{{ $stockLimit }}" min="1"
                                               class="form-control" placeholder="{{ \App\Utils\translate('stock_limit') }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlInput1">{{ \App\Utils\translate('time_zone') }}</label>
                                ...
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    ...
                                    <div class="form-group ">
                                        <label>{{ \App\Utils\translate('vat_reg_no') }}</label>
                                        <input class="form-control" type="text" name="vat_reg_no"
                                               placeholder="{{ \App\Utils\translate('vat_reg_no') }}" value="{{ $vatRegNo }}">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    @php($shopLogo = \App\Models\BusinessSetting::where('key', 'shop_logo')->first()->value)
                                    <div class="form-group ">
                                        <label>{{ \App\Utils\translate('logo') }}</label><small class="text-danger">* ( {{ \App\Utils\translate('ratio_1:1') }} )</small>
                                        ...
                                        <div class="text-center">
                                            <img class="img-one-bs my-4" id="viewer"
                                                 src="{{onErrorImage($shopLogo,asset('storage/shop').'/' . $shopLogo,asset('assets/admin/img/ecartify.png') ,'shop/')}}" alt="" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    ...
                                    <div class="form-group ">
                                        <label>{{ \App\Utils\translate('fav_icon') }}</label><small class="text-danger">* ( {{ \App\Utils\translate('ratio_1:1') }} )</small>
                                        <div class="custom-file">
                                            <input type="file" name="fav_icon" id="customFileEg2" class="custom-file-input"
                                                   accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                            <label class="custom-file-label" for="customFileEg2">{{ \App\Utils\translate('choose') }}{{ \App\Utils\translate('file') }}</label>
                                        </div>
                                        <div class="text-center">
                                            <img class="img-one-bs my-4" id="viewer2"
                                                 src="{{onErrorImage($favIcon, asset('storage/shop').'/' . $favIcon, asset('assets/admin/img/ecartify.png') ,'shop/')}}" alt="{{ \App\Utils\translate('fav_icon') }}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <button type="submit"
                                class="btn btn-primary mb-2">{{ \App\Utils\translate('submit') }}</button>
                        </form>
                    </div>
                </div>
            </div>
