...
@section('title',\App\Utils\translate('add_new_leave_request'))
    ...
    <div class="row align-items-center mb-3">
        <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title d-flex align-items-center g-2px text-capitalize"><i
                    class="tio-add-circle-outlined"></i> {{\App\Utils\translate('add_new_leave_request')}}
            </h1>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.leave-request.store')}}" method="post">
                            ...
                            <div class="col-12 col-md-12 pl-2 form-group">
                                ...
                                <input type="text" readonly class="form-control readonly" value="{{ $firstname_lastname }}"  placeholder="{{\App\Utils\translate('departement_name')}}" required>
                            </div>
                            <div class="col-12 col-md-12 pl-2 form-group">
                            ...
                            <div class="row ml-0 mr-0">
                                <div class="col-md-5">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="from" id="periode_du" class="input-group date form-control" data-provide="datepicker" data-date-language="fr" data-date-autoclose="true" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input  name="to" id="periode_au" class="input-group date form-control" data-provide="datepicker" data-date-language="fr" data-date-autoclose="true" autocomplete="off" placeholder="Période fin" readonly="readonly">
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-12 pl-2 form-group">
                                ...
                                <select name="nature_of_leave_id" class="form-control" required>
                                    ...
                                    @foreach($natureOfLeaves as $natureOfLeave)
                                        <option value="{{$natureOfLeave->id}}">{{$natureOfLeave->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-12 col-md-12 pl-2 form-group">
                                <label class="input-label" >{{\App\Utils\translate('reason')}}</label>
                                <textarea name="reason" class="form-control" placeholder="{{\App\Utils\translate('reason')}}">{{ old('reason') }}</textarea>
                            </div>
