...
function initializeFilePond(name, files = null, appURL, csrfToken) {
    ...
    if(files !== null && files.source){
        const pond = FilePond.create(document.querySelector(`input[name="${name}"]`), {
            allowMultiple: true,
            allowReorder: false,
