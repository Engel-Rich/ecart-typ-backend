...
--
-- Host: localhost:3306
-- Generation Time: Feb 04, 2024 at 06:49 AM
...
(1, 'Cash', 'Default account', 0, '1', 0, 0, '2024-11-28 05:06:59', '2024-12-01 08:11:58', NULL),
(2, 'Payable', 'td', 0, '2', 0, 0, '2024-11-28 05:07:21', '2024-12-01 05:02:22', NULL),
(3, 'Receivable', 'Default account', 0, '3', 0, 0, '2024-11-28 05:07:36', '2024-12-01 08:11:58', NULL);
...
(1, 'Master Admin', NULL, 1, '2024-02-04 06:48:37', '2024-02-04 06:48:37');
...
(3, 'Test Brand', '2023-10-25-65389205947d0.png', '2023-10-25 03:56:53', '2023-10-25 03:56:53', NULL);
...
(1, 'shop_logo', '2024-11-10-618b99fd673d2.png', NULL, NULL, NULL),
(2, 'pagination_limit', '16', NULL, NULL, NULL),
(3, 'currency', 'EUR', NULL, NULL, NULL),
(4, 'shop_name', 'Ecartify', NULL, NULL, NULL),
(5, 'shop_address', 'France', NULL, NULL, NULL),
(6, 'shop_phone', '0659898987', NULL, NULL, NULL),
(7, 'shop_email', 'shop@ecartify.com', NULL, NULL, NULL),
(8, 'footer_text', 'All rights reserved.', NULL, NULL, NULL),
(9, 'country', 'FR', NULL, NULL, NULL),
(10, 'stock_limit', '10', NULL, NULL, NULL),
(11, 'time_zone', 'Europe/Paris', NULL, NULL, NULL),
(12, 'vat_reg_no', '0000', NULL, NULL, NULL),
(13, 'fav_icon', NULL, NULL, NULL, NULL),
(14, 'currency_position','right', NULL, NULL, NULL);
...
(1, 'Test Category', 0, 0, 1, '2023-10-25-653891d1a698a.png', '2023-10-25 03:56:01', '2023-10-25 03:56:01', NULL),
(2, 'Test Sub Category', 1, 1, 1, 'def.png', '2023-10-25 03:56:25', '2023-10-25 03:56:25', NULL);
...
CREATE TABLE `companies` (
  ...
  `sub_domain_prefix` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'walking customer', '1', NULL, 'def.png', NULL, NULL, NULL, NULL, 0, '2024-11-28 05:37:48', '2024-11-28 05:37:48', NULL);
...
(20, '2021_11_17_083502_create_transactions_table', 2),
...
(48, '2024_02_27_104412_create_temporary_files_table', 7),
(49, '2024_02_27_132151_make_image_column_nullable_in_brands_table', 8),
(50, '2024_02_27_155543_make_image_column_nullable_in_categories_table', 9);
...
CREATE TABLE `products` (
  ...
  `unit_type` int UNSIGNED DEFAULT NULL,
...
(1, 'Test Product', '74982', 1, 1.00, '3', '[{\"id\":\"1\",\"position\":1},{\"id\":\"2\",\"position\":2}]', 70, 100, 'percent', 0.00, 0.00, 80, '2023-10-25-65389342b5f12.png', 0, 1, '2023-10-25 04:02:10', '2023-10-25 04:02:24', NULL);
...
(1, 'Test Supplier', '8801122334455', 'supplier@supplier.com', '2023-10-25-653892e145e47.png', 'Dhaka', 'Dhaka', '1000', 'Dhaka, Bangladesh', NULL, '2023-10-25 04:00:33', '2023-10-25 04:00:33', NULL);
...
CREATE TABLE `transactions` (
  `id` bigint UNSIGNED NOT NULL,
  `tran_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 'kg', '2024-11-28 05:34:53', '2024-11-28 05:34:53', NULL),
(2, 'Ltr', '2024-11-28 05:35:05', '2024-11-28 05:35:05', NULL),
(3, 'Pc', '2024-11-28 05:35:14', '2024-11-28 05:35:14', NULL);
